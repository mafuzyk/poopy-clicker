...
- `goober.gd` — velocidade do panic corrigida para a fórmula canônica `speed_max + 3` (era 2.2–3.0× fixo: goobers rápidos como speedy/tiny andavam mais rápido do que fugiam no panic). Com o `progression speed multiplier` futuro, a escala volta a compor.
