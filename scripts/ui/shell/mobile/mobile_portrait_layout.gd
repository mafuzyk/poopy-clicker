extends Control
class_name MobilePortraitLayout
...
func setup() -> void:
	...
	header_slot.custom_minimum_size = Vector2(0, UiTokens.MOBILE_HEADER_HEIGHT)
	...
	nav_slot.custom_minimum_size = Vector2(0, UiTokens.MOBILE_NAV_HEIGHT)
